...
### Cá nhân
- [X] Có use case từ Day 18/19
- [X] Có Unit of AI Work
- [X] Có một quality question rõ
- [X] Có ít nhất 3 dimensions và values
- [X] Có tối thiểu 10 scenarios/combinations (đang có: 12)
- [X] Có prompt đã dùng để generate inputs
- [X] Có tối thiểu 20 user inputs sau khi lọc
- [X] Có Scenario Dataset v0 cá nhân
